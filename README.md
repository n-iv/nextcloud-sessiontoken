...
**Original source:** [https://octoforge.fr/octopuce/sessiontoken](https://octoforge.fr/octopuce/sessiontoken)
...
cd apps
git clone https://github.com/n-iv/nextcloud-sessiontoken.git sessiontoken
cd sessiontoken
```
